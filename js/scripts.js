...
$(document).ready(function() { 
    "use strict";
    var mainId = document.getElementById('main-container');
    var navId = document.getElementById('nav-container');
    var mainOver = document.getElementById('main-overlay');
    var mainFazers = document.getElementById('main-fazers');
    var overBase = document.getElementById('over-base');
    var overFace = document.getElementById('over-face');
    var overLogo = document.getElementById('over-logo');
